class FollowChecker
  ...
  def cached_follow_check
    Rails.cache.fetch("user-#{follower.id}-#{follower.updated_at}/is_following_#{followable_type}_#{followable_id}", expires_in: 100.hours) do # rubocop:disable Metrics/LineLength
